// Параметры аутификации (логин,регистрация и прочее). Тут хранятся пути к ключам шифрования, апикеи различных сервисов авторизации (fb, vk, google....) и прочие настройки относящиеся к аутификации.
...
// Шарим в конфиге тот ключ который нужен.
// Если это ключи для JWT, то вам скорее всего нужен только публичный ключ.
